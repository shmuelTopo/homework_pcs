...
module.exports = () => {
    ...
    const first = listOfFirstNames[randomFirstIndex];
    const last = listOfLastNames[randomLastIndex];
    const email = getEmailFromName(first, last);
...
const getEmailFromName = (first, last) => {
